...
def event_identification(arena):        # NOTE: You can tweak this function in case you need to give more inputs 
    ...
    ADD YOUR CODE HERE
    '''
    e = arena[120:170, 160:210]
    d = arena[335:385, 147:197]
    a = arena[598:648, 155:205]
    c = arena[337:387, 465:515]
    b = arena[470:520, 460:510]
    cv.imwrite("a.png", a)
    cv.imwrite("b.png", b)
    cv.imwrite("c.png", c)
    cv.imwrite("d.png", d)
    cv.imwrite("e.png", e)
    event_list.append("a.png")
    event_list.append("b.png")
    event_list.append("c.png")
    event_list.append("d.png")
    event_list.append("e.png")
    print(event_list)
    return event_list
