...
# Team ID:      GG_3618		[ Team-ID ]
# Author List:  Logithsurya, Sherwin Kumar, Satyak, Sumeadh		[ Names of team members worked on this file separated by Comma: Name1, Name2, ... ]
# Filename:     Task_2D.py
# Functions:    read_csv, write_csv, tracker    [ Function names ]
###################################################################################################
